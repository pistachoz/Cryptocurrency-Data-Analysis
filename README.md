...
Here’s a link to a [Dashboard Report](https://www.novypro.com/project/cryptocurrency-data-analysis) that I created at the end of this project. It is an interactive report where I utilized the built-in predictive forecasting models in Power BI to forecast future market trends of the selected cryptocurrencies based on 95% confidence values within the next 12 months.
